...
if __name__ == '__main__':
    ...
    parser.add_argument('--source_img_path', type=str, default=r'F:\DataBase\zjjdataset\709nofog\images709')
    parser.add_argument('--source_xml_path', type=str, default=r'F:\DataBase\zjjdataset\709nofog\xml709')
    parser.add_argument('--save_img_path', type=str, default=r'F:\DataBase\zjjdataset\7090nofog\images')
    parser.add_argument('--save_xml_path', type=str, default=r'F:\DataBase\zjjdataset\7090nofog\xmls')
